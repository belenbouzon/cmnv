    ...
    <div class="zone-contact">
        <div class="zone-contact-top">
            <div id="consultas" class="zone-contact-form">
                <img class="img-responsive" src="images/astillero_fachada.jpg">
                <h2 class="m-t-30">Contacto</h2>
                <div style="color:#0A1330; font: bold italic 25px/27px 'Cormorant Garamond', Georgia, 'Times New Roman', Times, serif;">
                    <h3>+54 11 6009 7300<br>
                    <a href="mailto:ventas@cmnv.com.ar" style="color:#0A1330; text-decoration: none;">ventas@cmnv.com.ar</a></h3>
                </div>
                ...
                <div id="formulario" class="line m-t-40" style="background-color:#FFF; margin-top:30px; text-align:left; ">
                    <form method="POST" enctype="multipart/form-data" action="astillero.php#formulario">                            
                        ...
                        <label><input name="nombre" type="text" value="" placeholder="Nombre" class="inputs" style="width: 98%; height:35px;" required=""></label>
                        <label><input name="empresa" type="text" value="" placeholder="Empresa" class="inputs" style="width: 98%; height:35px;" required=""></label>
                        <label><input name="mail" type="email" value="" placeholder="Mail" class="inputs" style="width: 98%; height:35px;" required=""></label>
                        <label><input name="telefono" type="text" value="" placeholder="Telefono" class="inputs" style="width: 98%; height:35px;" required=""></label>
                        <label>
                            ...
                            <label style="text-align:left; padding:0"><input type="submit" class="btn" value="ENVIAR" style="margin:20px 0px 0 0px; font-weight:bold">
                        </label>                     
                    </form>
                       <label>
                    <label>
                       <h1 class="h-azul-grande"><span style="color:#F00; font-size:12px"> <?php if($_POST) { include("form-astillero.php"); } ?> <span style="color: #090; font-size: 18px; margin: 8px 0 10px 30px;  display: block;"> <?php echo $exitos; ?> </span></span></h1>
                        </label>
                    </label>
                </div>
            ...
            <div id="ubicacion" class="zone-contact-ubicacion">
                <div class="block-in maps" style="padding:0px;text-align:center; max-width:100%">
                    ...
                    <div class="data-amenities" id="amenities">
                        <h2>Azopardo 1337, Catalinas Sur<br>Ciudad de Buenos Aires, Argentina</h2>
<!--                         <ul>
                            <li>AZOPARDO 1337, CIUDAD DE BUENOS AIRES</li>
                        </ul> -->
                        <h2 style="margin-top:50px">Amenities y Servicios</h2>
                        <ul>
                        ...
                        <div class="data-icons m-t-60">
				            <div class="data-icons-content">
				                <div class="data-icons-content-brochure">
				                    <div style="width:32px; float:left; margin-right: 15px;">
				                        <img src="images/ico-brochure-n.png" />
				                    </div>
				                    <div style="float:left; padding:5px 0 0 0">
				                        <a target="_blank" href="http://www.cmnv.com.ar/descargas/brochure-astillero.pdf">Brochure</a>
				                    </div>
				                </div>
				                <div class="data-icons-content-facebook">
				                    <div style="width:32px; float:left; margin-right: 15px">
				                        <img src="images/ico-facebook-n.png" />
				                    </div>
				                    <div style="float:left; padding:5px 0 0 0">
