...
<div class="wrapper">
    ...
    <div id="slides">
        <div class="slides-container">
            <img src="images/astillero_slider_1.jpg">
            <img src="images/astillero_slider_2.jpg">
            <img src="images/astillero_slider_3.jpg">
            <img src="images/astillero_slider_4.jpg">
            <img src="images/astillero_slider_5.jpg">
            <img src="images/astillero_slider_6.png">      
        </div>
        ...
        <div class="zone-contact-top">
            <div id="consultas" class="zone-contact-form">
                ...
                <div id="formulario" class="line m-t-40" style="background-color:#FFF; margin-top:30px; text-align:left; ">
                    <form method="POST" enctype="multipart/form-data" action="astillero_catalinas_sur.php#formulario">                            
