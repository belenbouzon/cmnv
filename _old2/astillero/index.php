...
<div class="wrapper">
    ...
    <div class="line">
        ...
        <div style="float:left; width:100%; display:block; margin:35px 0; position:relative; text-align:center">
            ...
            <a class="link-astillero" href="https://goo.gl/maps/5C2CGfeMG7r" target="_blank">ubicación del proyecto</a><br/>
    	</div>
    ...
    <div id="formulario" class="line" style="background-color:#FFF; margin-top:30px; text-align:center; ">
            ...
            <form method="POST" enctype="multipart/form-data" action="index.php#formulario">                            
                ...
                <label>
                    <textarea class="inputs" name="comentarios" placeholder="Escribí aquí tu consulta" style="width: 95%; height:140px; border:inherit;" required=""></textarea>
                </label>
